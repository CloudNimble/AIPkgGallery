---
title: Overview
description: "A high-level map of the ~80 NuGetGallery components — grouped into core systems, shared infrastructure, and supplemental operations — with migration disposition notes for AI•Pkg."
icon: "sitemap"
---
