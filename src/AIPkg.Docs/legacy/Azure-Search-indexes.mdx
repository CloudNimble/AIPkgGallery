---
title: Azure Search Indexes
description: "Technical reference for NuGetGallery's dual Azure Search index design — the search index for package discovery and the hijack index for exact metadata lookup."
