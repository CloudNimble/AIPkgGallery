---
title: Deploying NuGet Gallery
description: "Guide to provisioning and deploying NuGetGallery to Azure — covering SQL Database setup, Blob Storage configuration, schema migration, and publishing to Azure App Service."
icon: "cloud-arrow-up"
---
