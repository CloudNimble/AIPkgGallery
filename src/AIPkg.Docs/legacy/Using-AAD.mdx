...
description: "Step-by-step guide to configuring NuGetGallery to authenticate users via Azure Active Directory — covering app registration, redirect URIs, client secrets, and Gallery web.config settings."
icon: "key"
---
