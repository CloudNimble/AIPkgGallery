...
description: "Guide to updating NuGetGallery's frontend — compiling LESS stylesheets with Bootstrap 3 and Grunt, and adding page-specific JavaScript with jQuery and Knockout.js."
icon: "palette"
---
