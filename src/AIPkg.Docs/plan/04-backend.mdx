---
title: "Backend"
sidebarTitle: "04 · Backend"
description: "Authentication, storage, search index, background jobs, NuGet V3 → AI•Pkg endpoint mapping, and server-side implementation details."
icon: "server"
---
