...
description: "`AI•Pkg.Core` public API types, `aipkg` CLI command syntax, and configuration file schemas — the normative interface for anyone building compatible tooling."
icon: "terminal"
---
