---
title: "AI•Pkg Specification Suite"
description: "Normative specifications for the AI•Pkg package format, platform targeting system, registry protocol, and SDK interface — everything needed to build a compatible tool or registry implementation."
icon: "book-open"
---
