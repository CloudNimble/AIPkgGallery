...
description: "AI•Pkg Registry API endpoint reference — service index, registration, flat container, search, autocomplete, push, platform list, and non-functional requirements."
icon: "server"
---
